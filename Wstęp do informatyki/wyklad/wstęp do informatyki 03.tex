...
\label{sec:org4f25f3b}
\subsection{Arytmetyczne}
\label{sec:org5c82d48}
\begin{center}
...
\end{center}
\subsubsection{AND}
\label{sec:orgee73b52}

\begin{enumerate}
\item A=1, B=2
\label{sec:org21ab1e3}
...
\end{verbatim}
\item \(A=0 , B=0\)
\label{sec:orgad82bb9}

\(A\) \&\& \(B =\) FALSE \\
FALSE \&\& FALSE \(=\) FALSE
\end{enumerate}
\subsubsection{OR}
\label{sec:org584a28a}
\(A=1, B=2\) \\
\(A\) || \(B\) = TRUE
\subsubsection{NOT}
\label{sec:org82f09de}
