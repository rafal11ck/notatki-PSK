...
\label{sec:org66f0b51}
\subsection{Arytmetyczne}
\label{sec:orgbd65d81}
\begin{center}
...
\end{center}
\subsubsection{AND}
\label{sec:org9ddde8a}

\begin{enumerate}
\item A=1, B=2
\label{sec:org0d9ca59}
...
\end{verbatim}
\item \(A=0 , B=0\)
\label{sec:org417534f}

\(A\) \&\& \(B =\) FALSE \\
FALSE \&\& FALSE \(=\) FALSE
\end{enumerate}
\subsubsection{OR}
\label{sec:orgc88231a}
\(A=1, B=2\) \\
\(A\) || \(B\) = TRUE
\subsubsection{NOT}
\label{sec:org773df6a}
