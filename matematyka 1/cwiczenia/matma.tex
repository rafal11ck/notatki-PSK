...
\(a,b\)
\subsection{Parabola}
\label{sec:org0900842}
\begin{description}
\item[{Wzór ogólny}] $$ax_1-bx_2^2=0$$
\end{description}
\subsection{Hiperbola}
\label{sec:orgb4fc153}
\begin{description}
\item[{Wzór ogólny}] 
\end{description}
$$\frac{x_1^2}{a^2}-\frac{x_2^2}{b^2}=1$$
...
\section{\(\mathbb{R}^3\)}
\label{sec:org006ba10}
\subsection{Równianie ogólne płaszczyzny}
\label{sec:org6496175}
